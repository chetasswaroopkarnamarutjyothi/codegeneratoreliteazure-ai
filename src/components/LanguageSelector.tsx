...
const LANGUAGES = [
  ...
  { value: "angular", label: "Angular", icon: "NG" },
  { value: "vue", label: "Vue", icon: "VU" },
  { value: "react", label: "React", icon: "RE" },
  { value: "svelte", label: "Svelte", icon: "SV" },
  { value: "dart", label: "Dart", icon: "DT" },
  { value: "flutter", label: "Flutter", icon: "FL" },
  { value: "scala", label: "Scala", icon: "SC" },
  { value: "perl", label: "Perl", icon: "PL" },
  { value: "lua", label: "Lua", icon: "LU" },
  { value: "haskell", label: "Haskell", icon: "HS" },
  { value: "elixir", label: "Elixir", icon: "EX" },
  { value: "clojure", label: "Clojure", icon: "CL" },
  { value: "fsharp", label: "F#", icon: "F#" },
  { value: "r", label: "R", icon: "R" },
  { value: "matlab", label: "MATLAB", icon: "ML" },
  { value: "bash", label: "Bash", icon: "SH" },
  { value: "powershell", label: "PowerShell", icon: "PS" },
  { value: "yaml", label: "YAML", icon: "YM" },
